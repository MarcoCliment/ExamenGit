	...
	public static void main(String[] args) {
		...
		for(int i=0;i<frase.length();i++){
			if(letra==frase.charAt(i)){
				numRepeticiones++;
				System.out.println("Letra "+letra+" encontrada en la posicion "+encuentraLetra(i,numPos));
			}
		}
		System.out.println("Total repeticiones "+cuentaRepeticiones(numRepeticiones));
	
	}
	public static int encuentraLetra(int i, int numPos){
		numPos=i+1;
		return numPos;
	}
	public static int cuentaRepeticiones(int numRepeticiones){
